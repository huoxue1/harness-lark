/**
 * Browser-trust fence for the harness-lark routes, behaviorally identical to
 ...
 *
 * @module harness-lark/trust-fence
 */
...
/** Source of the deployment's trusted-host authorities. */
export type TrustedHostsSource = () => readonly string[]
...
/**
 * Decide whether one plugin-route request may reach the handler.
